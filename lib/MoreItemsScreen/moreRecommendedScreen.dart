...
class moreRecommended extends StatefulWidget {
  @override
  State<moreRecommended> createState() => _moreRecommendedState();
}

class _moreRecommendedState extends State<moreRecommended> {
  @override
            ...
            Padding(
              ...
              child: GridView(
                shrinkWrap: true,
                  ...
                  children: dummyMoreRecommendePlantdetails.map(
                    (CustomVariable) {
